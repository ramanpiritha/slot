...
<html>
<head>
    <title>SLOT TIME TABLE - PIRITHARAMAN R (23013537)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - PIRITHARAMAN R(23013537)</strong></p>
    </div>
    <table>
        <tr>
...
## OUTPUT
![Screenshot (73)](https://github.com/user-attachments/assets/0e97984c-fea9-456c-bdc6-e48fbc7e316d)
